...
const BookingForm = () => {
 ...
 { value: 'CX Team', label: 'CX Team' },
  ...
  { value: 'entity - Contract', label: 'entity - Contract' },
  { value: 'entity - Digital Practice', label: 'entity - Digital Practice' },
  { value: 'entity - GE', label: 'entity - GE' },
  { value: 'entity - HR Ops', label: 'entity - HR Ops' },
  { value: 'entity - Intern', label: 'entity - Intern' },
  { value: 'entity - TAG', label: 'entity - TAG' },
  { value: 'entity - TAG/Recruitment', label: 'entity - TAG/Recruitment' },
  { value: 'entity - Toy', label: 'entity - Toy' },
  { value: 'entity - VGO', label: 'entity - VGO' },
  { value: 'entity (Malaysia)', label: 'entity (Malaysia)' },
  ...
  { value: 'GE - Contract Sample -', label: 'GE - Contract Sample -' },
  { value: 'GE Sample -', label: 'GE Sample -' },
  ...
  { value: 'Hallifyahmed', label: 'Hallifyahmed' },
  ...
  { value: 'Sample - Administration', label: 'Sample - Administration' },
  { value: 'Sample - Cloud DevOps - HXF', label: 'Sample - Cloud DevOps - HXF' },
  { value: 'Sample - Elixir', label: 'Sample - Elixir' },
  { value: 'Sample - IDP', label: 'Sample - IDP' },
  { value: 'Sample - IDP - Contract', label: 'Sample - IDP - Contract' },
  { value: 'Sample - IIM', label: 'Sample - IIM' },
  { value: 'Sample - Mobile App', label: 'Sample - Mobile App' },
  { value: 'Sample - Onboarding', label: 'Sample - Onboarding' },
  { value: 'Sample - QA', label: 'Sample - QA' },
  { value: 'Sample - (not Hallify payroll)', label: 'Sample - (not Hallify payroll)' },
  { value: 'Unique', label: 'Unique' },
  { value: 'Unique IT', label: 'Unique IT' },
  { value: 'Vandhana Ramakrishnan', label: 'Vandhana Ramakrishnan' },
  { value: 'Hallify Academy', label: 'Hallify Academy' },
  { value: 'Hallify Gulf FZE', label: 'Hallify Gulf FZE' },
  { value: 'Hallify Malaysia SDN BHD', label: 'Hallify Malaysia SDN BHD' },
  ...
  { value: 'Syed Ahmed (Hallify)', label: 'Syed Ahmed (Hallify)' },
